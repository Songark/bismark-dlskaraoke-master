...
public class SheetMusic extends SurfaceView implements SurfaceHolder.Callback, ScrollAnimationListener {
    ...
    private SheetMusicPlayer player;        /** For pausing the music */
    ...
    public SheetMusic(Context context) {
        ...
        playerHeight = SheetMusicPlayer.getPreferredSize(screenwidth, screenheight).y;
    }
    ...
    public void init(MidiFile file, MidiOptions options) {
        ...
        SetColors(null, options.shade1Color);
        paint = new Paint();
     ...
     */
    public void SetColors(int[] newcolors, int newshade1) {
        if (NoteColors == null) {
    ...
    public void setPlayer(SheetMusicPlayer p) {
        player = p;
    }
